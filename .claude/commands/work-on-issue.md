...
8. Summarize what changed, how it was verified, and the state of each definition of done item. Do not commit, push, or open a pull request unless asked. When asked to commit, read `.claude/skills/commit-conventions/SKILL.md` and follow it.
