...
8. Summarize what changed, how it was verified, and the state of each definition of done item. Do not commit, push, or open a pull request unless asked. When asked to commit, follow the commits section of the standards: several small commits with lowercase subjects, one per logical change.
